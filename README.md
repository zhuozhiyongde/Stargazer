...
-   [MARS-EAI/RoboFactory](https://github.com/MARS-EAI/RoboFactory) - RoboFactory: Exploring Embodied Agent Collaboration with Compositional Constraints
...
-   [goudanZ1/PKUElectiveHelper](https://github.com/goudanZ1/PKUElectiveHelper) - PKU 选课网手动抢课小助手（不是刷课机）
-   [zilliztech/deep-searcher](https://github.com/zilliztech/deep-searcher) - Open Source Deep Research Alternative to Reason and Search on Private Data. Written in Python.
...
-   [OmniSVG/OmniSVG](https://github.com/OmniSVG/OmniSVG) - OmniSVG: A Unified Scalable Vector Graphics Generation Model
